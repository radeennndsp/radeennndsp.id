...
// Import locale messages **sinkron**
import en from "@/messages/en.json";
import id from "@/messages/id.json";

const messagesMap: Record<string, any> = { en, id };
...
export const metadata: Metadata = {
  ...
  authors: { name: METADATA.creator, url: "https://radeennndsp.netlify.app" },
  openGraph: {
...
const RootLayout = ({ children, params }: RootLayoutProps) => {
  ...
  // Note: `getServerSession` tidak bisa dipakai async di sini, pindahkan ke server component page
